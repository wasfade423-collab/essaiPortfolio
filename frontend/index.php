...
<head>
    ...
    <link rel="shortcut icon" href="assets/user.ico" type="image/x-icon">
...
<body class="mx-0 px-0 bg-white overflow-x-hidden dark:bg-black dark:text-white">
    ...
    <main class="mt-4 px-2">
        ...
        <!-- Diplômes -->
        <section 
            class="min-h-[520px] h-[65vh] max-h-[550px]  rounded-3xl bg-slate-500/20 p-3" style="line-height:30px;">
            <h2
                class="font-bold text-2xl policeTitre">
                            ...
                            <div class="flex w-full gap-2">
                                ...
                                <div class="w-1/4 h-auto flex items-center justify-center">
                                    <div class="w-auto h-auto rounded-full overflow-hidden bg-gray-300 flex items-center justify-center">
                                        <img src="assets/user.png" class="w-full h-full object-cover">
                                    </div>
                                </div>
        ...
        <!-- Contact -->
        <section id="contact" 
            class="header scroll-mt-[11vh] h-[60vh] rounded-3xl bg-white pt-3 px-3" style="line-height:30px;">
            ...
            <form action="../backend/process.php" method="post" class="flex flex-col gap-2 policeText">
                ...
                <div class="flex items-center justify-end">
                    <input type="submit" value="Envoyez" class="bg-amber-500 font-bold text-white p-1 w-[100px] h-[40px] rounded-sm hover:bg-amber-600">
                </div>
            </form>
        </section>
    </main>
